Scenario: TC-046- Initial QC-Verify the "Corresponding Author" user link function
...
And [1100-0300] User click on it
And [1111-1000] Corresponding_Author_link should be clickable, Within 20 seconds
And [1100-0300] User click on it
