Scenario: TC-099-1 Initial QC-Task Tab - Check for Flagged Persons - Return Manuscrip button
...
And [1100-0300] User click on it
And [1111-1000] btn_Return_Manuscript should be clickable, Within 20 seconds
And [1100-0300] User click on it
