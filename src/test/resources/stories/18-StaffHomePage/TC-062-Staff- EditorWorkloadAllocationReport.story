...
And [1111-1000] stafftask_Editor_Workload_Allocation_Report should be clickable, Within 20 seconds
And [1100-0300] User click on it
And [1111-1080] view_Workloads_Allocations_Btn should be displayed, Within 20 seconds