Scenario: TC-007 - Publishing Permissions-Verify that "Dual Submission" option is a mandatory field
...
And [1111-1000] Publishing_Permissions_Tab should be clickable, Within 20 seconds
And [1100-0300] User click on it
And [1111-1080] dual_Error should be displayed, Within 20 seconds
And [1101-0140] Text should contain Dual Submission/Publication response is required.