Scenario: TC-012- Author Information-Verify Clicking on "Find Person's" button when entering (First , middle & last) name fields data
...
And [1100-1340] User fills Authors MName with Automation
