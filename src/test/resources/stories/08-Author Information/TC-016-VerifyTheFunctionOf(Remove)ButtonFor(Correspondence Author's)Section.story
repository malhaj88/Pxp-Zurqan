Scenario: TC-016- Author Information-Verify the function of "Remove" button for "Correspondence Author's" section.
...
And [1111-1000] Authors_Remove_btn should be clickable, Within 20 seconds
And [1100-0300] User click on it
And [1111-1080] None_Assigned_Msg should be displayed, Within 20 seconds
