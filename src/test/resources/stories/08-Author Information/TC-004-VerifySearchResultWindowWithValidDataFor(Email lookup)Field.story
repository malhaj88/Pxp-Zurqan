Scenario: TC-004- Author Information-Verify search result window with valid data for "Email lookup" field
...
And [1100-1340] User fills Email Lookup TestBox with email@domain.com
And [1111-1000] Search Btn should be clickable, Within 20 seconds
And [1100-0300] User click on it
And [1111-1080] Search EmailLookup Results should be displayed, Within 20 seconds