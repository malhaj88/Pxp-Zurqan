Scenario: TC-012- Reviewers-Clear fields from Suggested Reviewers to Exclude
...
And [1111-1000] Exclude_Clear_Btn should be clickable, Within 20 seconds
And [1100-0300] User click on it
And [1111-1080] Exclude_Reviewer_Email should be displayed, Within 20 seconds
And [1101-0100] Text should equal to `empty`
And [1111-1080] Exclude_Reviewer_LName should be displayed, Within 20 seconds
And [1101-0100] Text should equal to `empty`
And [1111-1080] Exclude_Reviewer_FName should be displayed, Within 20 seconds
And [1101-0100] Text should equal to `empty`
And [1111-1080] Exclude_Reviewer_Institution should be displayed, Within 20 seconds
And [1101-0100] Text should equal to `empty`
And [1111-1080] Exclude_Comments should be displayed, Within 20 seconds
And [1101-0100] Text should equal to `empty`
