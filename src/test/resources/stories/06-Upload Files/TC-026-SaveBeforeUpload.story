...
And [1100-0300] User click on it
And [1111-1000] Save_Exit should be clickable, Within 20 seconds
And [1100-0300] User click on it
Then [1111-1130] Message_Saved_data text should contain Submission data saved., Within 20 seconds
And [1101-1080] Home_Page should be displayed