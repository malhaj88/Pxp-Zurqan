Scenario: TC-006- Submit manuscript content-Return Home button
...
And [1100-0300] User click on it
And [1111-1000] Return_Home_Btn should be clickable, Within 20 seconds
And [1100-0300] User click on it
Then [1111-1130] Aip_Login_Message text should contain Home Page, Within 20 seconds